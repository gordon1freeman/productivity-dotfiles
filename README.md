# The *actual* productivity Hyprland setup

>Originally a ragebait, now my actual setup for laptop.
...
Heavily inspired by **[maxhu08's dotfiles](https://github.com/maxhu08/dotfiles)** (Waybar)
