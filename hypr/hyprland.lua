...
-- Launcher & utilities
hl.bind(mainMod .. " + Space", hl.dsp.exec_cmd("bash -c 'pkill fuzzel || fuzzel'"))
hl.bind(mainMod .. " + TAB",   hl.dsp.exec_cmd("bash -c 'pkill fuzzel || ~/.config/hypr/scripts/window-switch.sh'"))
hl.bind(mainMod .. " + R",     hl.dsp.exec_cmd(menu))
hl.bind(mainMod .. " + V",     hl.dsp.exec_cmd("bash -c 'cliphist list | fuzzel --dmenu | cliphist decode | wl-copy'"))
...
-- Layer rules (blur)
hl.layer_rule({ name = "fuzzel-blur", match = { namespace = "launcher" }, blur = true })
hl.layer_rule({ name = "fuzzel-fix",  match = { namespace = "launcher" }, ignore_alpha = 0.2 })-- Monitors
hl.monitor({
          output   = "eDP-1",
          mode     = "1920x1200@120.00Hz",
          position = "0x0",
